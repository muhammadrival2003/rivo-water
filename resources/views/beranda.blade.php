...
<div class="container mt-5">
    ...
    <div class="d-none d-md-block">
        <h1>Selamat datang di Rivo <span>Water</span></h1>
        <p class="headLine2">Lorem ipsum dolor sit amet consectetur adipisicing elit. Quisquam excepturi fuga alias eum quaerat aut?</p>
    </div>
    ...
    <div class="row mt-4">
        <div class="col-lg-4 d-flex justify-content-lg-start justify-content-center">
            <a class="btnHeader1 btn px-3 py-2 rounded-3 {{ ($title === 'Blog' ? 'active' : '') }}" href="/blog"><i class="bi bi-bag"></i> Beli Sekarang</a>
        </div>
    </div>
...
{{-- Tentang Produk --}}
<div class="container-fluid tentang-produk">
    <div class="row" style="font-family: 'Poppins', sans-serif">
        <h2 class="headline-tentang text-center"><span>Tentang</span> Produk</h2>
        <div class="col mt-5">
            <div class="card card-tentang mb-3" style="max-width: 940px;">
                <div class="row g-0">
                    ...
                    <div class="col-md-8">
                        <div class="card-body">
                            <h5 class="card-title title-tentang">Normal Water</h5>
            ...
            <div class="col mt-5 d-flex justify-content-end ">
                <div class="card card-tentang" style="max-width: 940px;">
                    <div class="row g-0">
                        <div class="col-md-8">
                            <div class="card-body">
                                <h5 class="card-title title-tentang">Reverse Osmosis</h5>
            ...
            <div class="card card-tentang mt-5" style="max-width: 940px;">
                <div class="row g-0">
                    <div class="col-md-4 p-4">
                        <img src="img/{{$image}}" class="img-fluid rounded" alt="...">
                    </div>
    ...
    {{-- Produk --}}
    <div class="content-3-7 overflow container-xxl mx-auto position-relative" style="font-family: 'Poppins', sans-serif">
        <div class="container mx-auto">
            ...
            <div class="list-produk row">
                ...
                <div class="col-lg-4 col-12">
                    <div class="card-item-outline d-flex flex-column position-relative overflow-hidden h-100" style="background-color: #2e3a53">
