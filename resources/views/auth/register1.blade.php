...
<div class="content-3-6 d-flex flex-column align-items-center h-100 flex-lg-row" style="font-family: 'Poppins', sans-serif;">
    <div class="position-relative d-none d-lg-block h-100 width-left">
        <img class="position-absolute img-fluid centered" src="img/Ilustrasion-key.png" alt="">
    </div>
    <div class="d-flex mx-auto align-items-left justify-content-left width-right mx-lg-0">
        <div class="right mx-lg-0 mx-auto">
            <div class="align-items-center justify-content-center d-lg-none d-flex">
                <img class="img-fluid" src="img/Ilustrasion-key.png" alt="">
            </div>
            <div class="row">
                <div class="col-lg-12 d-flex justify-content-between align-items-center">
                    <h3 class="title-text">Register</h3>
                    {{-- <span class="green-bottom-caption"><a href="{{ route('login') }}">SIGN IN</a></span> --}}
                    <a href="{{ route('login') }}" class="btn btn-primary" tabindex="-1" role="button" aria-disabled="true">SIGN IN</a>
                </div>
            </div>
            <form style="margin-top: 1.5rem;" action="{{ route('login') }}" method="POST">
                ...
                <div style="margin-bottom: 1.75rem;">
                    ...
                    <div class="d-flex w-100 div-input">
                        ...
                        {{-- <input class="input-field" type="email" name="" id="" placeholder="Masukkan Email"
                            autocomplete="on" required> --}}
                        <input id="email" type="email" class="input-field @error('email') is-invalid @enderror" name="email" value="{{ old('email') }}" required autocomplete="email" autofocus placeholder="Masukkan Email">
                ...
                <div style="margin-bottom: 1.75rem;">
                    ...
                    <div class="d-flex w-100 div-input">
                        <svg class="icon" style="margin-right: 1rem;" width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                            <path d="M7.207 1a1 1 0 0 0-1.414 0L.146 6.646a.5.5 0 0 0 .708.708L1 7.207V12.5A1.5 1.5 0 0 0 2.5 14h.55a2.51 2.51 0 0 1-.05-.5V9.415a1.5 1.5 0 0 1-.56-2.475l5.353-5.354L7.207 1Z" fill="#4E4B62" />
                            <path d="M8.793 2a1 1 0 0 1 1.414 0L12 3.793V2.5a.5.5 0 0 1 .5-.5h1a.5.5 0 0 1 .5.5v3.293l1.854 1.853a.5.5 0 0 1-.708.708L15 8.207V13.5a1.5 1.5 0 0 1-1.5 1.5h-8A1.5 1.5 0 0 1 4 13.5V8.207l-.146.147a.5.5 0 1 1-.708-.708L8.793 2Z" fill="#4E4B62" />
                        </svg>
                        <input id="email" type="email" class="input-field @error('email') is-invalid @enderror" name="email" value="{{ old('email') }}" required autocomplete="email" autofocus placeholder="Masukkan Alamat">
                ...
                <div style="margin-bottom: 1.75rem;">
                    <label for="" class="d-block input-label">No.HP</label>
                    <div class="d-flex w-100 div-input">
                        <svg class="icon" style="margin-right: 1rem;" width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                            <path fill-rule="evenodd" d="M1.885.511a1.745 1.745 0 0 1 2.61.163L6.29 2.98c.329.423.445.974.315 1.494l-.547 2.19a.678.678 0 0 0 .178.643l2.457 2.457a.678.678 0 0 0 .644.178l2.189-.547a1.745 1.745 0 0 1 1.494.315l2.306 1.794c.829.645.905 1.87.163 2.611l-1.034 1.034c-.74.74-1.846 1.065-2.877.702a18.634 18.634 0 0 1-7.01-4.42 18.634 18.634 0 0 1-4.42-7.009c-.362-1.03-.037-2.137.703-2.877L1.885.511z" fill="#4E4B62" />
                        </svg>
                        <input id="email" type="email" class="input-field @error('email') is-invalid @enderror" name="email" value="{{ old('email') }}" required autocomplete="email" autofocus placeholder="Masukkan No.HP">
                ...
                <div style="margin-top: 1rem;">
                    ...
                    <div class="d-flex w-100 div-input">
                        ...
                        {{-- <input class="input-field" type="password" name="" id="password-content-3-6"
                            placeholder="Masukkan Password" minlength="6" required> --}}
                        <input id="password" type="password" class="input-field @error('password') is-invalid @enderror" name="password" required autocomplete="current-password" placeholder="Masukkan Password">
                ...
                <div style="margin-top: 1rem;">
                    ...
                    <div class="d-flex w-100 div-input">
                        ...
                        <input id="password" type="password" class="input-field @error('password') is-invalid @enderror" name="password" required autocomplete="current-password" placeholder="Konfirmasi Password">
                ...
                <button class="btn btn-fill text-white d-block w-100" type="submit">Daftar</button>
            </form>
        </div>
    </div>
