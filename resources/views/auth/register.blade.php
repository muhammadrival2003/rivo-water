            ...
            <form style="margin-top: 1.5rem;" action="{{ route('register') }}" method="POST">
                ...
                <div style="margin-bottom: 1.75rem;">
                    ...
                    <div class="d-flex w-100 div-input">
                        ...
                        <input id="name" type="text" class="input-field @error('name') is-invalid @enderror" name="name" value="{{ old('name') }}" required autocomplete="name" autofocus placeholder="Masukkan Nama lengkap">
                ...
                <div style="margin-bottom: 1.75rem;">
                    ...
                    <div class="d-flex w-100 div-input">
                        ...
                        <input id="email" type="email" class="input-field @error('email') is-invalid @enderror" name="email" value="{{ old('email') }}" required autocomplete="email" placeholder="Masukkan Email">
                ...
                <div style="margin-top: 1rem;">
                    ...
                    <div class="d-flex w-100 div-input">
                        ...
                        <input id="password-confirm" type="password" class="input-field" name="password_confirmation" required autocomplete="new-password" placeholder="Konfirmasi Password">
